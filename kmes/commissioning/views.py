...
from ..commissioning.forms import (
...
class CommissioningSystemCreateView(BaseCreateView):
	...
	def get_success_url(self):
		return reverse('commissioning_system_detail', kwargs={'pk': self.object.pk})
...
class PunchItemCreateView(BaseCreateView):
	...
	def get_success_url(self):
		return reverse('punch_item_detail', kwargs={'pk': self.object.pk})
...
def punch_item_resolve_view(request, pk):
	...
	if request.method == 'POST':
		...
		if form.is_valid():
			...
			return redirect('punch_item_detail', pk=punch_item.pk)
	else:
...
class PunchItemPhotoUploadView(BaseCreateView):
	...
	def get_success_url(self):
		return reverse('punch_item_detail', kwargs={'pk': self.kwargs['punch_id']})
